...
class _DashboardTab extends StatelessWidget {
  ...
  const _DashboardTab({this.usuario});
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        // Navegar a mis reportes (cambiar tab)
                      },
              ...
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildBuilderDelegate(
                    ...
                    childCount:
                        reportes.reportes.length > 5 ? 5 : reportes.reportes.length,
                  ),
                ),
              ),
