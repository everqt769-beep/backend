...
import '../../admin/widgets/asignacion_dialog.dart'; // Importamos el diálogo
...
class _DetalleReporteScreenState extends State<DetalleReporteScreen> {
  ...
  // Función para mostrar el diálogo de asignación
  void _mostrarDialogoAsignacion() {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AsignacionDialog(reporteId: widget.reporteId);
      },
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Definimos si el botón de asignar debe ser visible
    ...
    return Scaffold(
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (reporte.categoria?.area != null) ...[
                          ...
                          Text(
                            'Área: ${reporte.categoria!.area!.nombre}',
                            style: const TextStyle(
                              fontSize: 12,
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 4),
                            Text(
                              'Reportado por: ${reporte.nombreUsuario}',
                              style: const TextStyle(
                                fontSize: 12,
                                color: AppColors.textHint,
                              ),
                  ...
                  const SizedBox(height: 20),
                  TimelineWidget(items: reporte.seguimientos ?? []),
                  const SizedBox(height: 20),
                  ComentariosWidget(
      ...
      // BOTÓN FLOTANTE PARA ASIGNAR (NUEVO)
